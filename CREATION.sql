...
DROP TABLE SAS_Magasin;
CREATE TABLE SAS_Magasin (
    ID_MAG NUMBER GENERATED BY DEFAULT AS IDENTITY,  -- Identifiant unique du magasin
    LIB_MAG VARCHAR2(255 CHAR),             -- Nom du magasin
    COD_ENS VARCHAR2(50 CHAR),              -- Code de l'enseigne
    LIB_ENS VARCHAR2(255 CHAR),             -- Nom de l'enseigne
    TEL VARCHAR2(50 CHAR),                  -- Numéro de téléphone
    ...
    ADR3 VARCHAR2(255 CHAR),                           -- Clé étrangère vers la table Localisation
...
CREATE TABLE SAS_REGION (
    ...
    ID_PAYS NUMBER                        -- Clé étrangère vers la table Pays 
);
...
CREATE TABLE SAS_DEP (
    ...
    ID_REG NUMBER                        -- Clé étrangère vers la table Région
);
...
CREATE TABLE SAS_VILLE (
    ...
    ID_DEP NUMBER                        -- Clé étrangère vers la table Département
);
